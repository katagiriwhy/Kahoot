...
## **Участники проекта:**
- **Кумекова Хасият** - 5130904/30104
- **Кузьмина Дарья** - 5130904/30104
- **Аюпов Дмитрий** - 5130904/30104
...
### **Frontend Разработка**
- **Кумекова Хасият**: Компоненты Register, Login, Home
- **Кузьмина Дарья**: Компоненты InterimPage, FinalPage, Lobby
- **Аюпов Дмитрий**: Компоненты QuestionPage, QuizCreate, CreateQuestions
